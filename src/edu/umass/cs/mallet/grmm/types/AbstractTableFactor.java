...
//  hash key.
  ...
  private Factor extractMaxInternal (AbstractTableFactor result)
  {
    ...
    System.out.println("extractMaxInternal in AbstractTableFactor is used");
  ...
  private void expandToContain (DiscreteFactor pot)
  {
    ...
    if (newVarSet.size () > numVars) {
    	System.out.println("expandToContain AbstractTableFactor !!!!!!!");
...
/* TODO: fold into probs.almostEqauals() if variable ordering
  ...
  {
	  System.out.println("Passing by this function get  log values !!!!");
    return ((Matrixn)getLogValueMatrix ()).toArray ();
  }

  public double[] getValues ()
  {
	  System.out.println("Passing by this function get values !!!!");
