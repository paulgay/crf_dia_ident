...
public class GenericAcrfData2TokenSequence extends Pipe {
  ...
  {
	this.labelDicts = new ArrayList ();//added for the case several instances do not share their vocabulary
    String input;
 ...
 *   Because lvl (which corresponds to the token number) is used to choose the alphabet. 
 */
  {
    ...
    return dict.lookupLabel (tok);//if "tok" is not in "dict" it will be added, the label will have this dictionnary
  }
