...
//	    	System.out.println("First time, parameter Number: "+i+" parameter value: "+parameters[i]);
	    ...
	    maxable.getParameters (parameters);
//	    for(int i=0;i<parameters.length;i++)
//	    	System.out.println("After the fisrt call to lineMaximizer, parameter Number: "+i+" parameter value: "+parameters[i]);
	    maxable.getValueGradient(g);
...
//	    for(int i=0;i<parameters.length;i++)
//	    	System.out.println("parameter Number: "+i+" parameter value: "+parameters[i]);
	    ...
	    maxable.getParameters (parameters);
//	    for(int i=0;i<parameters.length;i++)
//	    	System.out.println("After call to linesearch, parameter Number: "+i+" parameter value: "+parameters[i]);
	    maxable.getValueGradient(g);
