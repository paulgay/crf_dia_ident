 ...
 */
public class PairWiseMatrix implements Matrix, Cloneable {
	double[] values;
	int numDimensions;
	int[] sizes;
	/**
	...
	public PairWiseMatrix (int szs[],double[] vals) {
		try{
			if(szs.length!=2)
				throw new Exception("the pair wise matrix should have only 2 dimensions, found "+szs.length);
			numDimensions = szs.length;
	...
	public double value (int[] indices) {
		return values [singleIndexInner (indices)];
	}
	
	public void setValue (int[] indices, double value) {
		values [singleIndexInner (indices)] = value;
	}
	...
	public static int singleIndexInner (int[] indices)
	{
  ...
  public double[] toArray () {
    ...
    return values;
		...
		public static void main(String[] args) {
			...
			m.setValueAtLocation(44,19);
			System.out.println("using singleValue: "+m.singleValue(64)); // should give -19
			System.out.println("using value: "+m.value(idi)); // should give -19
			System.out.println("using singleValue: "+m.singleValue(66)); // should give -19
			System.out.println("using value: "+m.value(idi2)); // should give 19			
			System.out.println("numLocation: "+m.numLocations());
			System.out.println("valueAtLocation: "+m.valueAtLocation(56));
			System.out.println("valueAtLocation: "+m.valueAtLocation(11));
			System.out.println("singleIndex: "+m.singleIndex(idi2));
			int indices[] = new int[2];
			m.singleToIndices (66,  indices);
			System.out.println("singleToIndices: "+indices[0]+" "+ indices[1]);
		} 
