...
public class MainIdent2{
  ...
  private static BshInterpreter interpreter = setupInterpreter ();
	...
	try {
	    ...
	    //*
	    String pathFile = pathsfile.value.getAbsolutePath();
	    ...
	    InstanceFactoryIdent2 inputTestingPipe = new InstanceFactoryIdent2(pathFile,itNumber,showTest,acrf.getTemplates());
	    ...
	    Inferencer maxInf = createInferencer (maxInferencerOption.value);
	    acrf.setViterbiInferencer (maxInf);
	    AVDiarizationEval.writeMargin(acrf,testing,inputTestingPipe.getoutputDir(),itNumber);
