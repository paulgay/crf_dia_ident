...
public class MainIdent{
  ...
  private static BshInterpreter interpreter = setupInterpreter ();
	...
	try {
	    ...
	    InstanceFactoryIdent inputTestingPipe = new InstanceFactoryIdent(testingDataDir,itNumber,showTest,acrf.getTemplates());
	    ...
	    Inferencer maxInf = createInferencer (maxInferencerOption.value);
	    acrf.setViterbiInferencer (maxInf);
	    AVDiarizationEval.writeMargin(acrf,testing,itNumber);
